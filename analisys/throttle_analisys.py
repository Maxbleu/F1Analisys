...
def throttle_analisys(year:int, round:int, session:str, test_number:int, session_number:int):
    """
    ...
    fig, ax = plt.subplots()
    bars = ax.barh(df_mean_brake_drive.index, df_mean_brake_drive["Throttle"],
